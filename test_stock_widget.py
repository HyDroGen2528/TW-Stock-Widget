...
class StockWidgetTest(unittest.TestCase):
    ...
    def test_futures_realtime_parses_current_change_points(self):
        summary = parse_futures_realtime(
            {"quote": 40392, "change": "-1,181 (-2.84%)", "refer": 41573, "highest": 42070, "lowest": 39442, "isNoData": False}
        )
        self.assertIsNotNone(summary)
        self.assertEqual(summary.change_points, -1181)
        self.assertEqual(summary.change_pct, -2.84)
        self.assertEqual(summary.last, 40392)
